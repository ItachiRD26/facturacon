...
// Extrae el FechaHoraFirma EXACTO que quedó embebido en el XML firmado
// (dd-MM-yyyy HH:mm:ss) y lo devuelve como string tipo-ISO para pasarlo a
// formatFechaHoraQR(). El QR/consultatimbre debe usar el mismo FechaFirma
// que la DGII recibió dentro del XML firmado — usar un new Date() distinto
// (calculado después del POST de envío) causa "no encontrada" en
// consultatimbre porque no coincide con lo que la DGII tiene almacenado.
