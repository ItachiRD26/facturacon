...
// Idéntico a app/sites/[slug]/personalizacion/page.tsx pero leyendo el
// tenant del contexto de sandbox — así se puede configurar el logo desde
// antes de certificarse, no hace falta esperar a estar en producción.
...
export default function PersonalizacionSandboxPage() {
  const { tenant, tenantId } = useSandbox();
  const { personalizacion, loading } = usePersonalizacion(tenantId);
    ...
    <div className="fade-in">
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 13, color: "var(--c-text-3)" }}>
          El logo que subas aquí aparece en tus facturas impresas, en A4 y en térmica — se
          mantiene cuando te certifiques.
        </div>
      </div>
