    ...
    <div className="fade-in" data-tour="page-facturas">
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        <div>
          ...
          <div style={{ fontSize: 13, color: "var(--c-text-3)", fontFamily: sans }}>Comprobantes fiscales electrónicos de prueba</div>
        </div>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: "60px 0", fontFamily: sans }}>
          ...
          <div style={{ fontSize: 13, color: "var(--c-text-4)" }}>{facturas.length === 0 ? "Emite tu primera factura de prueba" : "Ajusta los filtros"}</div>
        </div>
      ) : (
