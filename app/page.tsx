...
const faqs = [
  ...
  },
  {
    ...
    a: "El sistema base funciona para cualquier negocio que facture productos o servicios (ferreterías, farmacias, consultoras, etc.). Si tu negocio tiene necesidades muy particulares (ej. hoteles con gestión de reservas) contáctanos para evaluar una solución a medida.",
  },
];

const pasos = [
  { n: "1", t: "Regístrate y describe tu negocio", d: "Crea tu cuenta y cuéntanos el RNC y el tipo de negocio que tienes." },
  { n: "2", t: "Pruébalo antes de comprometerte", d: "Te mostramos una demo guiada del sistema de facturación completo con datos de ejemplo." },
  ...
  { n: "4", t: "Empieza a facturar", d: "Accede a tu propio sistema de facturación electrónica, ya certificado y funcionando." },
];
...
export default function LandingPage() {
  return (
    <main style={{ fontFamily: "var(--font-sans)", color: "var(--c-text-1)" }}>
      ...
      {/* FAQ */}
      <section style={{ padding: "64px 24px", background: "var(--c-surface)", borderTop: "1px solid var(--c-border)" }}>
