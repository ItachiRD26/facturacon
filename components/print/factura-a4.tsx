...
export default function FacturaA4({ factura, cliente, empresa }: { factura: Factura; cliente?: Cliente; empresa: EmpresaImpresion }) {
  const totales = calcTotales(factura.items);
  const titulo = `Comprobante Fiscal Electrónico ${factura.tipoECF}`;

  return (
    <div style={{ fontFamily: "Arial, sans-serif", color: "#111", fontSize: 12, padding: 0 }}>
